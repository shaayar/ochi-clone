export const Footer = () => {
  ...
  const h1Classes = 'text-[6vw] neue font-semibold'
  const parts = 'h-full w-1/2 flex flex-col justify-between'
  const aClass = 'underline decoration-white'
  const aClasses = 'underline decoration-white w-32'

  return (
    <div className='w-full h-screen bg-zinc-800 p-10 flex'>
      <div className={parts}>
        <h1 className="text-8xl neue font-semibold">EYE- OPENING</h1>
      ...
      <div className={parts}>
        <h1 className={h1Classes}>PRESENTATIONS</h1>
        <div className="socials">
          <h1>S:</h1>
          <div className="links flex flex-col gap-1">
            <a href="#" className={aClass}>Instagram</a>
            <a href="#" className={aClass}>Behance</a>
            <a href="#" className={aClass}>Facebook</a>
            <a href="#" className={aClass}>LinkedIn</a>
          </div>
        </div>
        <div className="flex gap-2">
          <div className="w-1/2">
              ...
              <div className="links flex flex-col gap-2">
                <a href="#" className={aClasses}>202-1965 W 4th Ave Vancouver, Canada</a>
                <a href="#" className={aClasses}>30 Chukarina St Lviv, Ukraine</a>
              </div>
          </div>
          <div className="w-1/2">
            <div className="socials">
              ...
              <div className="links flex flex-col gap-1">
                ...
                <a href="#" className={aClass}>Services</a>
                <a href="#" className={aClass}>Our Work</a>
                <a href="#" className={aClass}>About Us</a>
                <a href="#" className={aClass}>Insights</a>
                <a href="#" className={aClass}>COntact Us</a>
              </div>
            </div>
          </div>
        </div>
        <div className="socials">
          <h1>E:</h1>
          <div className="links flex flex-col gap-1">
            <a href="mailto:hello@ochi.design" className={aClass}>hello@ochi.design</a>
          </div>
        </div>
      </div>
    </div>
